<?php
    if($eventNoComunes=="no" && $okFechas=="no")
    {
        ...
        $sql="SELECT * FROM bitacora_guardias";
    ...
    {
        //Mostrar TODA la bitácora
        $sql="SELECT * FROM bitacora_guardias where fecha between '$finicio' AND '$ffin'";
        $query=mysqli_query($con, $sql);
        if(!$query)
        {
            echo "Error al recuperar los datos de la bitácora.";
    ...
    {
        $sql="SELECT * FROM bitacora_guardias where operacion='Actualizado' or operacion='Eliminado' or usuario='AdministradorGod'";
        $query=mysqli_query($con, $sql);
        if(!$query)
        {
            echo "Error al recuperar los datos de la bitácora.";
    ...
    {
        $sql="SELECT * FROM bitacora_guardias where (operacion='Actualizado' or operacion='Eliminado')
