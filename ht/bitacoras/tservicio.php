<?php
    if($eventNoComunes=="no" && $okFechas=="no")
    {
        ...
        $sql="SELECT * FROM bitacora_tiempo_servicio";
    ...
    {
        //Mostrar TODA la bitácora
        $sql="SELECT * FROM bitacora_tiempo_servicio where fecha between '$finicio' AND '$ffin'";
        $query=mysqli_query($con, $sql);
        if(!$query)
        {
            echo "Error al recuperar los datos de la bitácora.";
    ...
    {
        $sql="SELECT * FROM bitacora_tiempo_servicio where operacion='Actualizado' or operacion='Eliminado' or usuario='AdministradorGod'";
        $query=mysqli_query($con, $sql);
        if(!$query)
        {
            echo "Error al recuperar los datos de la bitácora.";
    ...
    {
        $sql="SELECT * FROM bitacora_tiempo_servicio where (operacion='Actualizado' or operacion='Eliminado')
