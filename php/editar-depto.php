        ...
        <div id="right-panel" class="right-panel">
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="../ht/departamentos.php">Regresar a catálogo de departamentos</a></li>
            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                   <div class="row"> 
                       <form method="post" action="../php/update/depto.php" id="form2">   
                            <div class="col-lg-12">                        
                              <div class="card">
                                    <div class="card-header">
                                        <span id="MainContent_lbtitulo">Departamento existente</span>
                                    </div>
                                    <input type="hidden" name="old_id" value="<?php echo $id2[0]?>">
                                    <div class="card-body card-block">                          
                                       <div class="form-group col-lg-12">
                                            <span id="MainContent_lbCategoria">Departamento</span><input type="text" id="id-cat" name="idcat" value="<?php echo $id2[0]?>"  class="form-control" required="" />
                                       </div>
                                        <div class="form-group col-lg-12">
