        ...
        <div id="right-panel" class="right-panel">
                ...
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1>MODIFICAR TIPO DE EMPLEADO</h1>
                        </div>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="#">Regresar a catálogo de tipos de empleados</a></li>
            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                   ...
                   <div class="row"> 
                       <form method="post" action="../php/update/tipo-emp.php" id="form2">   
                            <div class="col-lg-12">                        
                              <div class="card">
                                    <div class="card-header">
                                        <span id="MainContent_lbtitulo">Tipo de empleado existente </span>
                                    </div>
                                    <input type="hidden" name="id" value="<?php echo $id2[0]?>">
                                    <div class="card-body card-block">                          
                                        <div class="form-group col-lg-12">
                                            <span id="MainContent_lbNombre">Nombre</span>
                                            <input type="text"   name="descripcion" value="<?php echo $id2[1]?>" class="form-control" required="" />
                                        </div>
                                    </div>
