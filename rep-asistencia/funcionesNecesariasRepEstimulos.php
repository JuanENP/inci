<?php
	...
	{
		/*
			Claves que no otorgan desempeño:
			78
		*/
	}
	function derecho_merito()
	{
		/*
			Claves que no otorgan merito relevante:
		*/
	}

	function derecho_trabajador()
	{
		/*
			Claves que no otorgan trabajador del mes:
		*/
	}
