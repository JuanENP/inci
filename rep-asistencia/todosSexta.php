                ...
                <?php        
                   ...
                   for($i=0;$i<$contador;$i++)
                    {  
                        ...
                        echo "<td>".$reporte[$i][11]."</td>";
                        echo "<td>".$reporte[$i][12]."</td>";
                        echo "<td>".$reporte[$i][13]."</td>";
                        echo "<td>".$reporte[$i][14]."</td>";
                        echo "<td>".$reporte[$i][15]."</td>";
                        echo "<td>".$reporte[$i][16]."</td>";
                        echo "<td>".$reporte[$i][17]."</td>";
                        echo"</tr>";
                    }
                ?>
            </tbody>
